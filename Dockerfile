...
RUN mkdir /data \
 ...
 && mkdir /data/master \
 && ls -al /opt/ \
 && ln -s /opt/greenplum-db-6-6.16.2 /opt/greenplum \
 && . /opt/greenplum/greenplum_path.sh && cp $GPHOME/docs/cli_help/gpconfigs/gpinitsystem_singlenode /data/ \
...
RUN useradd -md /home/gpadmin/ gpadmin \
 ...
 && echo "source /opt/greenplum/greenplum_path.sh" > /home/gpadmin/.bash_profile && chown gpadmin:gpadmin /home/gpadmin/.bash_profile \
